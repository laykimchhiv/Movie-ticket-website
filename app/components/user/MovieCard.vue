...
const { isInWatchlist, addToWatchlist, removeFromWatchlist, isInFavorites, addToFavorites, removeFromFavorites, isLoggedIn } =
  useAuth()

const isFav = computed(() => isInFavorites(props.movie.id))
